...
it('sets profile data and saves the model', function() {
...
it('returns the primary profile for a customer', function() {
    $paymentProfile = PaymentProfile::factory()->create([
        'customer_id' => 1,
        'is_primary' => true,
    ]);
...
it('returns the first profile if no primary profile exists', function() {
    $paymentProfile = PaymentProfile::factory()->create([
        'customer_id' => 1,
        'is_primary' => false,
    ]);
...
it('returns true if customer has a profile', function() {
...
it('returns false if customer does not have a profile', function() {
    $this->customer->customer_id = 1;
