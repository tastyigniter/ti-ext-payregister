...
it('returns true if payment is refundable', function() {
...
it('returns false if payment is not refundable', function() {
...
it('throws exception if processRefundForm is not implemented', function() {
