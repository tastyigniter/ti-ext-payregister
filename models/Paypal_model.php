...
class Paypal_model extends TI_Model
{
    ...
    public function doExpressCheckout($token, $payer_id, $order_info = [])
    {
    ...
    public function getTransactionDetails($transaction_id, $order_info = [])
    {
    ...
    {
        $settings = $this->Extensions_model->getSettings('paypal_express');
