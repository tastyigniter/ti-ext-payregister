...
class Authorize_net_aim_model extends TI_Model
{
    ...
    public function __construct()
    {
        ...
        $this->avsResponse = [
            'A' => lang('text_avs_response_A'),
            'B' => lang('text_avs_response_B'),
            'E' => lang('text_avs_response_E'),
            'G' => lang('text_avs_response_G'),
            'N' => lang('text_avs_response_N'),
            'P' => lang('text_avs_response_P'),
            'R' => lang('text_avs_response_R'),
            'S' => lang('text_avs_response_S'),
            'U' => lang('text_avs_response_U'),
            'W' => lang('text_avs_response_W'),
            'X' => lang('text_avs_response_X'),
            'Y' => lang('text_avs_response_Y'),
            'Z' => lang('text_avs_response_Z'),
        ];

        $this->ccvResponse = [
            'M' => lang('text_ccv_response_M'),
            'N' => lang('text_ccv_response_N'),
            'P' => lang('text_ccv_response_P'),
            'S' => lang('text_ccv_response_S'),
            'U' => lang('text_ccv_response_U'),
        ];

        $this->cavvResponse = [
            '0' => lang('text_cavv_response_0'),
            '1' => lang('text_cavv_response_1'),
            '2' => lang('text_cavv_response_2'),
            '3' => lang('text_cavv_response_3'),
            '4' => lang('text_cavv_response_4'),
            '5' => lang('text_cavv_response_5'),
            '6' => lang('text_cavv_response_6'),
            '7' => lang('text_cavv_response_7'),
            '8' => lang('text_cavv_response_8'),
            '9' => lang('text_cavv_response_9'),
            'A' => lang('text_cavv_response_A'),
            'B' => lang('text_cavv_response_B'),
        ];
    }

    public function authorizeAndCapture($order_data = [])
    {
        if (empty($order_data)) {
            return FALSE;
        }
    ...
    protected function sendToAuthorizeNet($data = [])
    {
