            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text"
                           ...
                           value="<?php echo set_value('stripe_cc_number', $stripe_cc_number); ?>"
                ...
                <div class="row">
                    <div class="col-xs-6 col-lg-6">
                        <input type="tel"
                               ...
                               value="<?php echo set_value('stripe_cc_exp_month', $stripe_cc_exp_month); ?>"
                    ...
                    <div class="col-xs-6 col-lg-6">
                        <input type="tel"
                               ...
                               value="<?php echo set_value('stripe_cc_exp_year', $stripe_cc_exp_year); ?>"
        ...
        <div class="col-xs-5 col-md-5 pull-right">
            <div class="form-group">
                ...
                <input type="tel"
                       class="form-control"
                       name="stripe_cc_cvc"
                       value="<?php echo set_value('stripe_cc_cvc', $stripe_cc_cvc); ?>"
