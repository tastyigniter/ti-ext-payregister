<div class="radio">
    ...
    <?php if ($minimum_order_total >= $order_total) { ?>
        <br/>
        <span class="text-info"><?php echo sprintf(lang('alert_min_order_total'), currency_format($minimum_order_total)); ?></span>
    <?php } ?>
</div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text"
                           ...
                           value="<?php echo set_value('authorize_cc_number', $authorize_cc_number); ?>"
                           placeholder="<?php echo lang('text_cc_number'); ?>"
                           autocomplete="off"
                           required/>
                ...
                <div class="row">
                    <div class="col-xs-6 col-lg-6">
                        <input type="text"
                               ...
                               value="<?php echo set_value('authorize_cc_exp_month', $authorize_cc_exp_month); ?>"
                               placeholder="<?php echo lang('text_exp_month'); ?>"
                               autocomplete="off"
                               required/>
                    </div>
                    <div class="col-xs-6 col-lg-6">
                        <input type="text"
                               ...
                               value="<?php echo set_value('authorize_cc_exp_year', $authorize_cc_exp_year); ?>"
                               placeholder="<?php echo lang('text_exp_year'); ?>"
                               autocomplete="off"
                               required/>
                    </div>
                </div>
        ...
        <div class="col-xs-5 col-md-5 pull-right">
            <div class="form-group">
                ...
                <input type="text"
                       ...
                       value="<?php echo set_value('authorize_cc_cvc', $authorize_cc_cvc); ?>"
                ...
                <?php if ($order_type == '1') { ?>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox"
                                   value="1"
                                   name="authorize_same_address" <?php echo set_checkbox('authorize_same_address', '1', TRUE) ?> />
                        ...
                        <?php foreach ($addresses as $address) { ?>
                            <?php if ($address['address_id'] == $authorize_address_id) { ?>
                                <option value="<?php echo $address['address_id']; ?>"
                                        selected="selected"><?php echo $address['address']; ?></option>
                            <?php } else { ?>
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        <input type="text"
                               ...
                               value="<?php echo set_value('authorize_address_1'); ?>"
                               placeholder="<?php echo lang('label_address_1'); ?>"
                               required/>
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        <input type="text"
                               ...
                               value="<?php echo set_value('authorize_address_2'); ?>"
                               placeholder="<?php echo lang('label_address_2'); ?>"/>
                ...
                <div class="col-xs-6">
                    <div class="form-group">
                        <input type="text"
                               class="form-control"
                               name="authorize_city"
                               value="<?php echo set_value('authorize_city'); ?>"
                               placeholder="<?php echo lang('label_city'); ?>"/>
                ...
                <div class="col-xs-6">
                    <div class="form-group">
                        <input type="text"
                               ...
                               value="<?php echo set_value('authorize_state'); ?>"
                               placeholder="<?php echo lang('label_state'); ?>"/>
                ...
                <div class="col-xs-6">
                    <div class="form-group">
                        <input type="text"
                               ...
                               value="<?php echo set_value('authorize_postcode'); ?>"
                               placeholder="<?php echo lang('label_postcode'); ?>"/>
